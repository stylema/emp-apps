...
import { Form, Col, Input, Select, Button, Tooltip } from 'antd';
...
const Page = ({ form, form: { getFieldDecorator, getFieldValue }, data }) => {
  ...
  return (
    <Form layout="inline">
      ...
      <Col span={24}>
        <Form.Item label={<>结果<Tooltip title="如果后端api返回的数据是 { list: [], count: 100 },想要把list的数据传入控件, 那么此处填写list即可"><CopyFilled style={{ fontSize: '16px', color: '#08c' }}/></Tooltip></>}>
